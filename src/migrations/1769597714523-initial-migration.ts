...
export class InitialMigration1769597714523 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "address" ("city" character varying(50) NOT NULL, "country" character varying(50) NOT NULL, "number" character varying(15) NOT NULL, "street" character varying(50) NOT NULL, "zipCode" character varying(10) NOT NULL, "personId" uuid NOT NULL, CONSTRAINT "PK_e3d0b5ba0387be88105ad7683bb" PRIMARY KEY ("personId"))`);
        await queryRunner.query(`CREATE TABLE "person" ("name" character varying(50) NOT NULL, "surname" character varying(50) NOT NULL, "phone" integer NOT NULL, "photo" character varying(50), "userId" uuid NOT NULL, CONSTRAINT "PK_83b775da14886d352de2a4cac01" PRIMARY KEY ("userId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(100) NOT NULL, "createTime" TIMESTAMP NOT NULL DEFAULT now(), "updateTime" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "hashed_password" ("userId" uuid NOT NULL, "hash" character varying NOT NULL, "salt" character varying NOT NULL, CONSTRAINT "PK_ba69521950c3445d64018779293" PRIMARY KEY ("userId"))`);
        await queryRunner.query(`CREATE TABLE "user_roles_role" ("userId" uuid NOT NULL, "roleName" character varying NOT NULL, CONSTRAINT "PK_8e8a23b3ea43dd063b8726385cd" PRIMARY KEY ("userId", "roleName"))`);
        ...
        await queryRunner.query(`ALTER TABLE "address" ADD CONSTRAINT "FK_e3d0b5ba0387be88105ad7683bb" FOREIGN KEY ("personId") REFERENCES "person"("userId") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "person" ADD CONSTRAINT "FK_83b775da14886d352de2a4cac01" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "hashed_password" ADD CONSTRAINT "FK_ba69521950c3445d64018779293" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "user_roles_role" ADD CONSTRAINT "FK_02914c59615da1ef38e848e324a" FOREIGN KEY ("roleName") REFERENCES "role"("name") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "hashed_password" DROP CONSTRAINT "FK_ba69521950c3445d64018779293"`);
